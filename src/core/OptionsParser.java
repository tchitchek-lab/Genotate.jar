...
public class OptionsParser {
	...
	private static String help = "\n\n"
			...
			+ "\n"
			+ "\nUsage : genotate.jar -input nucleic_sequences.fasta -output test -services service1,service2[score]"
			+ "\n"
			+ "\nExemple : genotate.jar -input nucleic_sequences.fasta -output test -services PRIAM,SABLE,CDD,COILS,BLASTN[db1,85,50,50],BLASTP[db2,85,50,50] "
